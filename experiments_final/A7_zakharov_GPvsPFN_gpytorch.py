...
if __name__ == "__main__":
    zakharov_GPvsPFN(num_runs=1, train_size=20, dimensions=20, num_inits=4, num_epochs=100, save_path='./results/zakharov/temp')
    # zakharov_GPvsPFN(num_runs=1, train_size=10, dimensions=20, num_inits=4, num_epochs=10000, save_path='./results/zakharov/temp', standardize_X=False, standardize_y=False)
    # zakharov_GPvsPFN(num_runs=1, train_size=10, num_inits=4, num_epochs=10000, save_path='./results/zakharov/tempv2', V2=True)
