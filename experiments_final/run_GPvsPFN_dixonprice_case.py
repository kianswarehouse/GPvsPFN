...
wing_SF_GPvsPFN(title="warmup", num_folds=1, train_size=10, num_epochs=1, num_runs=1, save_path=None, noise_train=0.005, noise_test=0.005, num_test=num_test, run_models=run_models)
...
# %% Dixon Price -------------------------------------------------------------  
dixon_price_GPvsPFN(title=title, num_folds=num_folds, train_size=10, dimensions=80, save_path=save_path_dixon_price, noise_train=0.005, noise_test=0.005, num_test=num_test, run_models=run_models)
dixon_price_GPvsPFN(title=title, num_folds=num_folds, train_size=20, dimensions=80, save_path=save_path_dixon_price, noise_train=0.005, noise_test=0.005, num_test=num_test, run_models=run_models)

dixon_price_GPvsPFN(title=title, num_folds=num_folds, train_size=10, dimensions=80, save_path=save_path_dixon_price, noise_train=0.05, noise_test=0.05, num_test=num_test, run_models=run_models)
dixon_price_GPvsPFN(title=title, num_folds=num_folds, train_size=20, dimensions=80, save_path=save_path_dixon_price, noise_train=0.05, noise_test=0.05, num_test=num_test, run_models=run_models)
