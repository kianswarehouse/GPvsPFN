...
wing_SF_GPvsPFN(title="warmup", num_runs=1, train_size=10, num_epochs=1, num_runs=1, save_path=None, noise_train=0.005, noise_test=0.005, num_test=num_test, run_models=run_models)
