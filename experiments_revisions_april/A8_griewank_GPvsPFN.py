    ...
    for i in range(num_runs):
        ...
        if run_models in [None, 'gp']:
            ...
            run_gp_prediction_diagnostics(
                ...
                truth_fn=lambda X: griewank_function(X, dimensions),
...
if __name__ == "__main__":
    # griewank_GPvsPFN(num_runs=1, train_size=40, dimensions=10, num_inits=16, noise_train=0.005, noise_test=0.005, save_path='./results/griewank/visualize_gp', run_models='gp')
    # griewank_GPvsPFN(num_runs=1, train_size=40, dimensions=20, num_inits=16, noise_train=0.005, noise_test=0.005, save_path='./results/griewank/visualize_gp', run_models='gp')
    griewank_GPvsPFN(single_dataset=False, num_runs=3, train_size=40, dimensions=40, num_inits=16, noise_train=0.005, noise_test=0.005, save_path='./results/griewank/test_parallel_diagnostics_win_maybe', run_models='gp')
