...
from load_experimental_data import (
    generate_tabpfn_1d_sin_2pi_x_windowed_data,
    tabpfn_1d_sin_2pi_x_windowed_function,
)


def tabpfn1d_sin_2pi_x_windowed_GPvsPFN(
    ...
    save_path="./results/TabPFN1D_sin_2pi_x_windowed",
    title=None,
    ...
    _base_mod.generate_tabpfn_1d_sin_2pi_x_data = generate_tabpfn_1d_sin_2pi_x_windowed_data
    _base_mod.tabpfn_1d_sin_2pi_x_function = tabpfn_1d_sin_2pi_x_windowed_function
    try:
        return _base_run(
            num_runs=num_runs,
            num_test=num_test,
...
if __name__ == "__main__":
    tabpfn1d_sin_2pi_x_windowed_GPvsPFN(
        num_runs=5,
        train_size=20,
        dimensions=1,
        num_inits=4,
        num_epochs=10000,
        save_path="./results/TabPFN1D_sin_2pi_x_windowed/test",
        run_models="pfn",
    )
