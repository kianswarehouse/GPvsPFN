...
def griewank_GPvsPFN_pregenParams(num_runs=defaults.NUM_RUNS,
        num_test=5000,
    ...
    if title is None:
        title = f"Griewank_pregenParams_{dimensions}Dx_{train_size}Dn_[{x_bounds[0]},{x_bounds[1]}]_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
    else:
        title = f"Griewank_pregenParams_{title}_{dimensions}Dx_{train_size}Dn_[{x_bounds[0]},{x_bounds[1]}]_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
...
if __name__ == "__main__":
    griewank_GPvsPFN_pregenParams(num_runs=20, train_size=10, dimensions=10, num_inits=16, save_path='./results/griewank/temp', run_models='gp')
    # griewank_GPvsPFN_pregenParams(num_runs=1, train_size=20, dimensions=20, num_inits=4, save_path='./results/griewank/temp')
    # griewank_GPvsPFN_pregenParams(num_runs=1, train_size=10, dimensions=40, num_inits=4, save_path='./results/griewank/temp')
    # griewank_GPvsPFN_pregenParams(num_runs=1, train_size=20, dimensions=40, num_inits=4, save_path='./results/griewank/temp')
