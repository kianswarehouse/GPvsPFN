...
def rosenbrock_GPvsPFN_pregenParams(num_runs=defaults.NUM_RUNS,
        num_test=5000,
    ...
    if title is None:
        title = f"Rosenbrock_pregenParams_{dimensions}Dx_{train_size}Dn_[{x_bounds[0]},{x_bounds[1]}]_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
    else:
        title = f"Rosenbrock_pregenParams_{title}_{dimensions}Dx_{train_size}Dn_[{x_bounds[0]},{x_bounds[1]}]_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
...
if __name__ == "__main__":
    ...
    rosenbrock_GPvsPFN_pregenParams(title='WARMUP', num_runs=1, train_size=2, dimensions=10, num_inits=2, noise_test=0.005, noise_train=0.005, save_path=None, run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title='test_analysis_1_1e-12jitter', num_runs=1, train_size=10, dimensions=40, num_inits=16, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=10, num_test=10000, dimensions=40, num_inits=4, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=10, dimensions=10, num_inits=4, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=10, dimensions=10, num_inits=4, noise_test=0.05, noise_train=0.05, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=10, dimensions=10, num_inits=16, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=10, dimensions=10, num_inits=16, noise_test=0.05, noise_train=0.05, save_path='./results/rosenbrock/power_exponential', run_models='gp')

    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=40, dimensions=5, num_inits=4, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=40, dimensions=10, num_inits=4, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=40, dimensions=10, num_inits=4, noise_test=0.05, noise_train=0.05, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=40, dimensions=10, num_inits=16, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=20, train_size=40, dimensions=10, num_inits=16, noise_test=0.05, noise_train=0.05, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    
    # rosenbrock_GPvsPFN_pregenParams(title='test_analysis_1_1e-12jitter', num_runs=1, train_size=10, dimensions=40, num_inits=16, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=10, num_test=10000, dimensions=40, num_runs=4, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=10, dimensions=40, num_runs=4, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=10, dimensions=40, num_runs=4, noise_test=0.05, noise_train=0.05, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=10, dimensions=40, num_runs=16, noise_test=0.005, noise_train=0.005, save_path='./results/rosenbrock/power_exponential', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=10, dimensions=40, num_runs=16, noise_test=0.05, noise_train=0.05, save_path='./results/rosenbrock/power_exponential', run_models='gp')

    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=1, train_size=40, dimensions=5, num_runs=4, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=4, train_size=40, dimensions=40, num_runs=4, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=4, train_size=40, dimensions=40, num_runs=4, noise_test=0.05, noise_train=0.05, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=4, train_size=40, dimensions=40, num_runs=16, noise_test=0.005, noise_train=0.005, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
    # rosenbrock_GPvsPFN_pregenParams(title=title, num_runs=4, train_size=40, dimensions=40, num_runs=16, noise_test=0.05, noise_train=0.05, save_path=f'./results/rosenbrock/{kernel}', run_models='gp')
