...
def wing_SF_GPvsPFN_pregenParams(num_runs=defaults.NUM_RUNS,
        num_test=5000,
        ...
        sobol_init_seed=42,
        # If None, uses ``seed`` for the single master SobolEngine in hyperparameter space.
    ):
    ...
    if title is None:
        title = f"wing_SF_pregenParams_{train_size}Dn_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
    else:
        title = f"wing_SF_pregenParams_{title}_{train_size}Dn_{num_inits}inits_noiseTest{noise_test}_noiseTrain{noise_train}_x{num_runs}"
    ...
    if run_models in (None, "gp") and num_inits > 0:
        ...
        if standardize_X:
            ...
            Xscaler_tm.fit(X_tm)
            X_tm = Xscaler_tm.transform(X_tm)
...
if __name__ == "__main__":
    wing_SF_GPvsPFN_pregenParams(num_runs=4, train_size=10, num_test=5000, noise_train=0, noise_test=0, num_inits=4, num_epochs=100, save_path="./results/wing/temp")

    # wing_SF_GPvsPFN_pregenParams(num_runs=1, train_size=10, num_test=5000, noise_train=0, noise_test=0, num_inits=4, num_epochs=100, save_path="./results/wing/temp")
    # wing_SF_GPvsPFN_pregenParams(trainer_info=False, num_runs=1, train_size=10, num_test=5000, noise_train=0, noise_test=0, num_inits=1, num_epochs=1, save_path="./results/wing/temp")
    # wing_SF_GPvsPFN_pregenParams(num_runs=1, train_size=10, num_test=5000, noise_train=0.05, noise_test=0.05, num_inits=4, num_epochs=10000, save_path="./results/wing/temp")
    # wing_SF_GPvsPFN_pregenParams(num_runs=5, train_size=80, num_test=5000, noise_train=0.05, noise_test=0.05, num_inits=4, num_epochs=10000, save_path="./results/wing/temp")
