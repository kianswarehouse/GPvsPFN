...
# gp_metrics_80_V2, tabpfn_metrics_80_V2 = ackley_GPvsPFN(num_seeds=num_seeds, num_runs=num_runs, train_size=80, dimensions=20, save_path=save_path_ackley_V2, V2=True, optimizer_class=optimizer)
