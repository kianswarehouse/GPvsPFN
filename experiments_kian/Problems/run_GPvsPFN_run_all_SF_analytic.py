...
ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_ackley_V2, V2=True)
ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_ackley_V2, V2=True)
...
# save_path_ackley = f"./results/ackley/{date}/40D"
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_ackley, noise_train=0.05, noise_test=0.05)
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_ackley, noise_train=0.05, noise_test=0.05)

# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_ackley, noise_train=0.005, noise_test=0.005)
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_ackley, noise_train=0.005, noise_test=0.005)
...
# save_path_ackley_V2 = f"./results/ackleyV2/{date}/40D"
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_ackley_V2, V2=True, noise_train=0.05, noise_test=0.05)
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_ackley_V2, V2=True, noise_train=0.05, noise_test=0.05)

# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_ackley_V2, V2=True, noise_train=0.005, noise_test=0.005)
# ackley_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_ackley_V2, V2=True, noise_train=0.005, noise_test=0.005)
...
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=10, dimensions=5, save_path=save_path_rastrigin_5d, noise_train=0.0, noise_test=0.0)
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=20, dimensions=5, save_path=save_path_rastrigin_5d, noise_train=0.0, noise_test=0.0)
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=40, dimensions=5, save_path=save_path_rastrigin_5d, noise_train=0.0, noise_test=0.0)
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=80, dimensions=5, save_path=save_path_rastrigin_5d, noise_train=0.0, noise_test=0.0)
...
# # No noise benchmark bounds [-5.12, 5.12]
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_rastrigin_40d, noise_train=0.0, noise_test=0.0)
rastrigin_GPvsPFN(num_folds=num_folds, bounds=[-5.12, 5.12], num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_rastrigin_40d, noise_train=0.0, noise_test=0.0)
# 0.005 noise
...
griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.0, noise_test=0.0)
griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.0, noise_test=0.0)
#0.005 Noise
# griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.005, noise_test=0.005)
# griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.005, noise_test=0.005)
# #0.05 Noise
# griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.05, noise_test=0.05)
# griewank_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=40, save_path=save_path_griewank_40d, noise_train=0.05, noise_test=0.05)
...
# %% Styblinksi ------------------------------------------------------------------------------------------------
save_path_styblinski_5d = f"{save_path_styblinski}/5xdim"
styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.0, noise_test=0.0)
styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.0, noise_test=0.0)
styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=40, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.0, noise_test=0.0)
styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=80, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.0, noise_test=0.0)
# 0.005 Noise
# styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.005, noise_test=0.005)
# styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.005, noise_test=0.005)
# styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=10, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.05, noise_test=0.05)
# styblinski_tang_GPvsPFN(num_folds=num_folds, num_runs=num_runs, train_size=20, dimensions=5, save_path=save_path_styblinski_5d, noise_train=0.05, noise_test=0.05)
