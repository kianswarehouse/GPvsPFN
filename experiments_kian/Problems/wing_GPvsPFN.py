...
def wing_GPvsPFN(num_seeds=20,
    ...
    X_test, y_test = generate_mf_wing_data(samples_per_source=num_test, noise=noise_test, noise_type=noise_type)
    # set_seed(100)
    X_train_all, y_train_all = generate_mf_wing_data(samples_per_source=total_train, noise=noise_train, noise_type=noise_type)
