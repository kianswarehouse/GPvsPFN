...
buckling_GPvsPFN(title=title, num_folds=num_folds, num_runs=num_runs, train_size=[40, 20], noise_train=[0.05, 0.1], noise_test=[0.05, 0.1], save_path=save_path_buckling)
