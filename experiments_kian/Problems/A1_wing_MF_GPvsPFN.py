...
def wing_GPvsPFN(num_folds=defaults.NUM_FOLDS,
    ...
    if title is None:
        title = f"wing_MF_{train_size}Dn_{num_runs}runs_noiseTest{noise_test}_noiseTrain{noise_train}"
    else: 
        title = f"wing_MF_{title}_{train_size}Dn_{num_runs}runs_noiseTest{noise_test}_noiseTrain{noise_train}"
