...
def borehole_SF_GPvsPFN(num_runs=defaults.NUM_RUNS,
        num_test=5000,
    ...
    if title is None:
        title = f"borehole_SF_gpytorch_{train_size}D_{num_inits}runs_noiseTest{noise_test}_noiseTrain{noise_train}"
    else: 
        title = f"borehole_SF_gpytorch{title}_{train_size}D_{num_inits}runs_noiseTest{noise_test}_noiseTrain{noise_train}"
...
if __name__ == "__main__":
    borehole_SF_GPvsPFN(num_runs=1, lr=0.1, train_size=10, num_test=5000, noise_train=0.0025, noise_test=0.025, num_inits=4, num_epochs=5000, save_path="./results/borehole/temp/gpytorch")
    # borehole_SF_GPvsPFN(num_runs=1, train_size=10, num_test=5000, noise_train=0.05, noise_test=0.05, num_inits=4, num_epochs=10000, save_path="./results/borehole/temp")
    # borehole_SF_GPvsPFN(num_runs=5, train_size=80, num_test=5000, noise_train=0.05, noise_test=0.05, num_inits=4, num_epochs=10000, save_path="./results/borehole/temp")
