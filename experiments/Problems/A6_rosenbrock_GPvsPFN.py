...
def rosenbrock_GPvsPFN(num_folds=defaults.NUM_FOLDS,
    ...
    for i in range(num_folds):
        ...
        input_dim = X_train.shape[1]  # dimensions for rosenbrock problem
...
if __name__ == "__main__":
    rosenbrock_GPvsPFN(num_folds=1, train_size=10, dimensions=20, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=20, dimensions=20, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=40, dimensions=20, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=80, dimensions=20, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=10, dimensions=40, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=20, dimensions=40, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=40, dimensions=40, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
    rosenbrock_GPvsPFN(num_folds=1, train_size=80, dimensions=40, num_runs=4, save_path='./results/rosenbrock/temp', use_recorder=True)
