    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.is_onehot:
            ...
            # MUST determine num_fidelities BEFORE initializing noise model
            if training_data is not None:
                # Extract fidelities from training data immediately
                ...
                # Cannot determine num_fidelities without data - raise error
                raise ValueError(
