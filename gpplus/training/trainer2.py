...
class GPTrainer:
    ...
    def __init__(
        ...
        if stop_conditions is None:
            ...
            self.stop_conditions = [
                ConvergencePatienceStopCondition(patience=40), # Kian: Increased from 20 to 40
                MinLossChangeStopCondition(min_loss_change=1e-7),
            ]
        else:
        ...
        if optimizer_kwargs is None:
            ...
            self.optimizer_kwargs = {"max_iter": 40}  # Kian: Increased from 20 to 40
    ...
    def train_multiple_process_parallel(self):
        ...
        if self.device.type == "cpu":
            ...
            max_jobs = min(self.num_runs, 2) # Kian: Only using 2 in parallel for high-dimensinal problems
            logger.info(
