...
# NOTE(kianb): PyTorch deprecated PYTORCH_CUDA_ALLOC_CONF in favour of
# PYTORCH_ALLOC_CONF. Using the new variable name avoids allocator warnings
# while preserving the intended max_split_size_mb behaviour.
