...
class TabPFNRegressor(RegressorMixin, BaseEstimator):
    ...
    _OUTPUT_TYPES_BASIC = ("mean", "median", "mode", "ei", "pi", "variance")
    ...
    def predict(  # noqa: C901, PLR0912
        ...
        *,
        ...
        quantiles: list[float] | None = None,
        best_f: Optional[float, torch.Tensor] = None
    ) -> (
        np.ndarray
        | list[np.ndarray]
        | dict[str, np.ndarray]
        ...
        # Debug
        output = logit_to_output(output_type=output_type)
...
def _logits_to_output(
    *,
    ...
    if output_type == "mean":
        ...
        output = criterion.ei(logits, best_f), # noqa: ERA001
    elif output_type == "pi":
        output = criterion.pi(logits, best_f), # noqa: ERA001
...
#     # TODO: consider moving the following to constants.py
#     _OUTPUT_TYPES_BASIC = ("mean", "median", "mode", "variance", "pi", "ei")
#     """The basic output types supported by the model."""
#     _OUTPUT_TYPES_QUANTILES = ("quantiles",)
#     """The quantiles output type supported by the model."""
#     _OUTPUT_TYPES = _OUTPUT_TYPES_BASIC + _OUTPUT_TYPES_QUANTILES
